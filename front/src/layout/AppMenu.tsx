            ...
            items: [
                {
                    ...
                    items:
                        [
                            ...
                            { label: 'Areas (Cargos)', icon: 'pi pi-fw pi-user', to: '/dashboard/reports/areas' },
                            { label: 'Empleados', icon: 'pi pi-fw pi-user', to: '/dashboard/reports/employees' },
                            { label: 'Usuarios', icon: 'pi pi-fw pi-user', to: '/dashboard/reports/users' },
                            { label: 'Nomina', icon: 'pi pi-fw pi-user', to: '/dashboard/reports/nomina' },
                        ]
                },
            ]
        },
    ...
    return (
        <MenuProvider>
            <ul className="layout-menu">
                ...
                {/* <Link to="/" className="flex justify-content-start w-full mt-8" style={{ cursor: 'pointer' }}
                    onClick={() => {
                        logout();
                    }}
                >
                    <Button label="Cerrar Sesión" icon="pi pi-check" iconPos="left" className="p-button-text p-button-plain" />
                </Link> */}
            </ul>
        </MenuProvider>
    );
