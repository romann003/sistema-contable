                    ...
                    <>
                        ...
                        <div className="flex">
                            <div className="field-radiobutton flex-1">
                                ...
                                <label htmlFor="mode1">Fijo</label>
                            </div>
                            <div className="field-radiobutton flex-1">
                        ...
                        <div className="flex">
                            <div className="field-radiobutton flex-1">
                                ...
                                <label htmlFor="outlined_input">Sin Fondo</label>
                            </div>
                            <div className="field-radiobutton flex-1">
                                ...
                                <label htmlFor="filled_input">Con Fondo</label>
                            </div>
                        </div>

                        <h5>Efecto Suavizado</h5>
